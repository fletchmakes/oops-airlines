...
function game_update()
	...
	elseif mode == "FLIGHT" and animation.is_animating == false then
		...
		if plane_spawn_timer <= 0 then -- prevent overflowing the pool  and #active_planes < #planes	
			...
			plane_spawn_timer = 120 + flr(rnd()*100)
		end
...
function game_draw()
	...
	if mode == "PLAN" then
		...
		pal({[0]=0,129,128,128,134,133,134,134,136,132,4,133,140,141,14,7},1)
	else
		-- reset to default
		pal()
	end
...
function draw_crosshair()
	if mode == "PLAN" then 
		if dist(cam.get_reticle(cam), {x=airport.x+8,y=airport.y+8}) < 6 then
			spr(14, 28, 28) return
		end
		spr(10, 28, 28) 
	end
...
__gfx__

...

